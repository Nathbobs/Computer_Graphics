...
def main():
    ...
    window = glfwCreateWindow(800, 800, '10-assignment: 2022089552', None, None)
    if not window:
        glfwTerminate()
        return
    ...
    right_wrist =Node(right_arm, glm.translate(glm.vec3(.5,0,0)), glm.translate((.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    left_arm =        Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    left_wrist =  Node(left_arm, glm.translate(glm.vec3(-.5,0,0)), glm.translate((-.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        left_wrist.set_joint_transform(glm.rotate(t, (0,0,-1)))
        right_arm.set_joint_transform(glm.rotate(t, (0,0,1)))
        right_wrist.set_joint_transform(glm.rotate(t, (0,0,1)))
        ...
        draw_node(vao_box, left_wrist, P*V, loc_MVP_box, loc_color_box)
        draw_node(vao_box, right_arm, P*V, loc_MVP_box, loc_color_box)
        draw_node(vao_box, right_wrist, P*V, loc_MVP_box, loc_color_box)
