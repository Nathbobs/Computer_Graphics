...
def main():
    ...
    right_arm = Node(base, glm.translate(glm.vec3(.2,0,0)), glm.translate((.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
     
    #default one #arm = Node(base, glm.translate(glm.vec3(.2,0,0)), glm.translate((.5,0,.01)) * glm.scale((.5,.1,0.)), glm.vec3(1,0,0))
    right_second_arm = Node(right_arm, glm.translate(glm.vec3(.5,.0,.0)), glm.translate((.25,.0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0)) #additional arm.
    #second_arm = Node(arm, glm.translate((.5,0,.02)) * glm.scale((.5,.1,0.)), glm.vec3(0,1,0)) #additional arm.
    left_arm = Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    left_second_arm = Node(left_arm, glm.translate(glm.vec3(-.5,0,0)), glm.translate((-.25,.0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0)) #additional arm.
    ...
    while not glfwWindowShouldClose(window):
        ...
        right_arm.set_joint_transform(glm.rotate(t, (0,0,1)))
        right_second_arm.set_joint_transform(glm.rotate(t, (0,0,1))) #new
        left_arm.set_joint_transform(glm.rotate(t, (0,0,-1)))
        left_second_arm.set_joint_transform(glm.rotate(t, (0,0,-1))) #new
        ...
        draw_node(vao_box, left_arm, P*V, loc_MVP_box, loc_color_box)
        draw_node(vao_box, left_second_arm, P*V, loc_MVP_box, loc_color_box) #new

        
        draw_node(vao_box, right_arm, P*V, loc_MVP_box, loc_color_box)
        draw_node(vao_box, right_second_arm, P*V, loc_MVP_box, loc_color_box) #new
